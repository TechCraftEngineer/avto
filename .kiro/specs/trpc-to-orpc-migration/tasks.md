...
- [x] 7. Создание главного роутера
  - [x] 7.1 Создать packages/api/src/root-orpc.ts
  ...
  - [x] 7.2 Написать property тесты для типобезопасности
...
- [x] 8. Создание Next.js route handler
  - [x] 8.1 Создать apps/app/src/app/api/orpc/[...orpc]/route.ts
  ...
  - [x] 8.2 Написать integration тест для route handler
...
- [x] 9. Контрольная точка - Проверка серверной части
  - Убедиться что все серверные тесты проходят
  - Проверить что API endpoint /api/orpc доступен
  - Задать вопросы пользователю если что-то неясно

- [x] 10. Создание клиентской конфигурации
  - [x] 10.1 Создать apps/app/src/orpc/react.tsx
  ...
  - [x] 10.2 Создать apps/app/src/orpc/server.ts для серверных хелперов
    - Создать функцию для prefetch на сервере
    - Настроить интеграцию с HydrationBoundary
    - _Requirements: 7.5, 11.2, 11.3_
  
  - [x] 10.3 Написать property тесты для клиента
...
- [x] 11. Обновление layout.tsx для использования ORPCProvider
  - [x] 11.1 Добавить ORPCReactProvider в apps/app/src/app/layout.tsx
  ...
  - [x] 11.2 Написать integration тест для провайдеров
    - Тест: Оба провайдера работают одновременно
    - Тест: oRPC клиент доступен через useORPC
    - _Requirements: 12.1_

- [x] 12. Создание примера использования на клиенте
  - [x] 12.1 Создать тестовый компонент с использованием oRPC
  ...
  - [x] 12.2 Написать property тесты для клиентских операций
    - **Property 19: Инвалидация конкретного запроса**
    - **Property 20: Инвалидация всего роутера**
    - **Validates: Requirements 8.2, 8.3**

- [x] 13. Контрольная точка - Проверка клиентской части
  - Убедиться что все клиентские тесты проходят
  - Проверить что тестовый компонент работает корректно
  - Задать вопросы пользователю если что-то неясно

- [x] 14. Реализация оптимистичных обновлений
  - [x] 14.1 Создать пример оптимистичного обновления
  ...
  - [x] 14.2 Написать property тест для оптимистичных обновлений
    - **Property 21: Оптимистичное обновление с откатом**
    - **Validates: Requirements 9.4**

- [x] 15. Реализация server-side prefetch
  - [x] 15.1 Создать пример серверного компонента с prefetch
  ...
  - [x] 15.2 Написать property тест для prefetch
    - **Property 24: Prefetch на сервере**
    - **Validates: Requirements 7.5, 11.3**

- [x] 16. Миграция остальных роутеров (batch 1: user, organization, vacancy)
  - [x] 16.1 Мигрировать user роутер
  ...
  - [x] 16.5 Написать integration тесты для мигрированных роутеров
...
- [x] 17. Контрольная точка - Проверка первого batch миграции
  - Убедиться что все тесты проходят
...
- [x] 19. Миграция остальных роутеров (batch 3: все оставшиеся)
  ...
  - [x] 19.3 Написать сравнительные тесты
...
- [x] 20. Контрольная точка - Проверка полной миграции роутеров
  - Убедиться что все 27 роутеров мигрированы
  - Убедиться что все тесты проходят
  - Проверить что структура root-orpc.ts идентична root.ts
  - Задать вопросы пользователю если что-то неясно

- [x] 21. Обновление клиентского кода для использования oRPC
  - [x] 21.1 Создать скрипт для поиска всех использований useTRPC
    - Найти все файлы с импортом useTRPC
    - Создать список файлов для миграции
    - _Requirements: 7.1_
  
  - [x] 21.2 Мигрировать клиентские компоненты (batch подход)
...
- [ ] 26. Создание примеров использования
  ...
  - [x] 26.2 Создать примеры клиентского использования
