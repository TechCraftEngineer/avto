...
8. Напиши анализы (все в формате HTML с тегами <p>, <strong>, <ul>/<li>, <br>):
   - Общий анализ соответствия (2-3 предложения)
   - Анализ навыков (1-2 предложения)
   - Анализ опыта (1-2 предложения)
   - Анализ потенциала кандидата (2-3 предложения)
   - Анализ карьерной траектории (2-3 предложения)
   - Анализ скрытых индикаторов соответствия, если они есть (1-2 предложения)
