 ...
 *
 * —оздаЄт новую сессию преквалификации дл€ кандидата.
 * ѕублична€ процедура - не требует авторизации пользовател€.
 */
...
const createSessionInputSchema = z.object({
  workspaceId: z.string().min(1, "workspaceId об€зателен"),
  ...
  .mutation(async ({ ctx, input }) => {
    ...
    try {
      ...
      throw new ORPCError({
        ...
        message: "¬нутренн€€ ошибка сервера",
        cause: error,
      });
    }
  });
