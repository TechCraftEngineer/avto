  ...
  const faqCategories = [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Нет, платформа разработана для HR-специалистов без технического бэкграунда. Интерфейс интуитивен, все настройки выполняются через визуальный редактор, в том числе настройка интервью в веб-чате.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Базовая настройка занимает 15-20 минут: регистрация, подключение HeadHunter, создание первой вакансии и настройка критериев скрининга. Настройка интервью в веб-чате занимает ещё 5-10 минут.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          question: "Нужно ли кандидату устанавливать приложения?",
          answer:
            "Нет, интервью проходит в веб-чате по ссылке — достаточно браузера на любом устройстве. Кандидату не нужно ничего скачивать или регистрироваться отдельно.",
        },
      ],
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            "Вы можете настроить: критерии оценки резюме, весовые коэффициенты навыков, сценарии интервью, тон и стиль общения в веб-чате, автоматические ответы и уведомления. Все настройки сохраняются в вашем проекте и применяются ко всем вакансиям.",
        },
        {
          question: "Можно ли управлять несколькими компаниями?",
          answer:
            "Да, платформа поддерживает мультитенантность через проекты. Каждый проект — это отдельная компания с изолированными данными, индивидуальными настройками AI и командой участников.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "На тарифе Enterprise доступна кастомизация: загрузка логотипа компании, настройка цветовой схемы, персонализация email-уведомлений, брендирование веб-чата для кандидатов.",
        },
      ],
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            "Все credentials шифруются AES-256 перед сохранением в БД. Данные изолированы по проекту. Соблюдается соответствие 152-ФЗ о персональных данных и требования Роскомнадзора.",
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Ограничения зависят от тарифа (в месяц): Бесплатный: 25 откликов (1 вакансия), Стартовый: 150 откликов (3 вакансии), Профессиональный: 1 000 откликов (10 вакансий), Корпоративный: без ограничений. Неиспользованные отклики не переносятся на следующий месяц.",
        },
      ],
    },
    {
