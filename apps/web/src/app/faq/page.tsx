...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@qbs-autonaim/ui/accordion"
    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Ограничения зависят от тарифа: Бесплатный — 25 откликов в месяц (1 вакансия), Стартовый — 150 откликов в месяц (3 вакансии), Профессиональный — 1 000 откликов в месяц (10 вакансий), Корпоративный — без ограничений в месяц. Неиспользованные отклики не переносятся на следующий месяц.",
        },
      ],
    },
    {
