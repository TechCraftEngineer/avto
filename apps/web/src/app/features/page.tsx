...
export const metadata = {
  ...
  description:
    "AI-скрининг резюме, интервью в веб-чате, аналитика воронки найма и интеграции с популярными сервисами — всё в одной платформе для автоматизации подбора персонала.",
}
