...
export function FAQSection() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Мы принимаем оплату от физических и юридических лиц любыми удобными способами: банковские карты, безналичный расчет по счету, электронные кошельки. Для юридических лиц доступна оплата с НДС и полный пакет закрывающих документов.",
    },
  ]
