...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: "100 откликов раньше — это 2 недели ручной работы. Сейчас — 2 дня до лонг-листа. Скрининг по нашим критериям отсекает нерелевантных, остаются только те, кого имеет смысл звать на интервью.",
  ...
  },
  {
    ...
    rating: 5,
    text: "Стартап не потянет штатного рекрутера. QBS закрыл этот разрыв: за 3 месяца наняли 15 разработчиков. Интеграция с hh.ru, интервью в Telegram — всё работает из коробки.",
  ...
  },
  {
    ...
    rating: 5,
    text: "Кандидаты отвечают в мессенджере в 3 раза чаще, чем на email. Голосовые интервью через Telegram — каждый рекрутер экономит по 4 часа в день на первичных созвонах.",
