...
export function ScreeningCta({ appUrl }: ScreeningCtaProps) {
  const signupUrl = `${appUrl}/auth/signup?redirect=/onboarding`;
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border-2 border-primary/20 bg-gradient-to-b from-muted/40 to-muted/10 p-6 text-center shadow-sm">
      ...
      <p className="text-muted-foreground text-sm mb-4">{COPY.cta.text}</p>
