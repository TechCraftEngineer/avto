...
export const gigScoringSchema = z.object({
  ...
  authenticityPenalty: z.number().min(0).max(5).default(0)
  ...
  summary: z.object({
    keyTakeaways: z.array(z.string())
      .describe('Ключевые выводы о кандидате'),
    redFlags: z.array(z.string())
      .describe('Тревожные сигналы'),
    greenFlags: z.array(z.string())
      .describe('Положительные индикаторы'),
  }),
});
...
export const vacancyScoringSchema = z.object({
  ...
  summary: z.object({
    ...
    concerns: z.array(z.string())
      .describe('Опасения и вопросы'),
    positives: z.array(z.string())
      .describe('Сильные стороны'),
  }),
});
