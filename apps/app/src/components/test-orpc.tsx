...
/**
 * Тестовый компонент для демонстрации использования oRPC с TanStack Query
 *
 * Демонстрирует:
 ...
 *
 * @see Requirements 5.2, 6.7, 7.2, 7.3, 8.2
 */
export function TestORPC() {
  ...
  return (
    <div className="container mx-auto max-w-4xl py-8">
      <Card>
        <CardHeader>
          <CardTitle>Тестирование oRPC</CardTitle>
          <CardDescription>
            Демонстрация работы с oRPC и TanStack Query
          </CardDescription>
        </CardHeader>
