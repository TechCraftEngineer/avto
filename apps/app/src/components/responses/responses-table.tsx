...
export function ResponsesTable({
  ...
  if (isLoading) {
    return (
      <div className="rounded-lg border-border bg-card shadow-sm overflow-hidden">
        <Table>
          <TableHeader>
            <TableRow>
  ...
  if (responses.length === 0) {
    return (
      <div className="rounded-lg border border-dashed border-border bg-muted/30 text-center py-12">
