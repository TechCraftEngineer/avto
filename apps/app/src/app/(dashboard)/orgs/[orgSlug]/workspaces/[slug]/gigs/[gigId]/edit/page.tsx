  ...
  return (
    <div className="container mx-auto max-w-4xl py-6">
      <PageHeader
        ...
        tooltipContent={`На этой странице можно изменить название, описание и параметры задания. После сохранения изменения применятся ко всем связанным процессам.\n\n[Подробнее в документации](${process.env.NEXT_PUBLIC_DOCS_URL}/gigs)`}
      />
