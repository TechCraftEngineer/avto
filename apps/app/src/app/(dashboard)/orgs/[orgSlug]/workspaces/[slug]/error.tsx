        ...
        <div className="w-full max-w-2xl space-y-8 text-center">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-md mx-auto">
              У вас нет прав для просмотра этой рабочей области. Если вы
              считаете, что это ошибка, обратитесь к администратору организации.
            </p>
          </div>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <h2 className="text-xl font-semibold tracking-tight">
              Не удалось загрузить рабочую область
            </h2>
          </div>
          <p className="text-lg text-muted-foreground max-w-md mx-auto">
            Произошла непредвиденная ошибка при загрузке рабочей области.
